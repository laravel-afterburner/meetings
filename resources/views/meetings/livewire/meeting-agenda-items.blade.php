                ...
                <div class="flex flex-wrap items-start justify-between gap-3">
                    <div class="min-w-0 flex-1">
                        ...
                        @if ($item->referenceViewUrl())
                            <a href="{{ $item->referenceViewUrl() }}"
                               class="mt-2 inline-block text-xs text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">
                                View linked record
                            </a>
                        @endif
                    </div>
                    ...
                    @if ($canManageAgenda)
                        <div class="flex flex-wrap items-center gap-2 shrink-0">
                            ...
                            <x-secondary-button type="button" wire:click="openEditModal({{ $item->id }})" no-spinner>
                                Edit
                            </x-secondary-button>
                            <button type="button"
        ...
        <x-slot name="content">
            <div class="space-y-4">
                <div>
                    ...
                    <x-input id="agenda-item-title" type="text" class="mt-1 block w-full" wire:model="title" />
                    <x-input-error for="title" class="mt-2" />
                </div>

                <div>
                    <x-label for="agenda-item-notes" value="Notes" />
                    <textarea id="agenda-item-notes" rows="3" wire:model="notes"
                ...
                <div>
                    ...
                    <select id="agenda-item-section" wire:model="section"
            ...
            <div class="space-y-4">
                ...
                @if ($linkProviderKey)
                    ...
                    <div>
                        ...
                        <select id="selected-reference-id" wire:model="selectedReferenceId"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100">
